...
MIDDLEWARE = [
    ...
    # Middleware для логирования CommerceML запросов
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'timeout': 60,  # Таймаут ожидания разблокировки базы (60 секунд) - увеличено для обработки больших файлов
...
SITE_DESCRIPTION = 'Каталог автозапчастей с доставкой по всей России. Большой выбор запчастей для автомобилей. Оптовые и розничные продажи. Доставка в Москву, Санкт-Петербург, регионы России.'
...
SITE_KEYWORDS = 'автозапчасти, запчасти для автомобилей, купить автозапчасти, автозапчасти Россия, доставка автозапчастей по России, каталог автозапчастей, интернет-магазин автозапчастей, автозапчасти с доставкой, оптовые автозапчасти, розничные автозапчасти, автозапчасти Москва, автозапчасти Санкт-Петербург, автозапчасти Новосибирск, автозапчасти Екатеринбург, автозапчасти Казань, автозапчасти Нижний Новгород, автозапчасти Челябинск, автозапчасти Самара, автозапчасти Омск, автозапчасти Ростов-на-Дону, автозапчасти Уфа, автозапчасти Красноярск, автозапчасти Воронеж, автозапчасти Пермь, автозапчасти Волгоград, автозапчасти Краснодар, автозапчасти Саратов, автозапчасти Тюмень, автозапчасти Тольятти, автозапчасти Ижевск, автозапчасти Барнаул, автозапчасти Ульяновск, автозапчасти Иркутск, автозапчасти Хабаровск, автозапчасти Ярославль, автозапчасти Владивосток, автозапчасти Махачкала, автозапчасти Томск, автозапчасти Оренбург, автозапчасти Кемерово, автозапчасти Новокузнецк, автозапчасти Рязань, автозапчасти Набережные Челны, автозапчасти Астрахань, автозапчасти Пенза, автозапчасти Липецк, автозапчасти Тула, автозапчасти Калининград, автозапчасти Уссурийск, автозапчасти Приморский край, автозапчасти Сибирь, автозапчасти Дальний Восток, автозапчасти Урал, автозапчасти Центральная Россия, автозапчасти Поволжье, запчасти для авто по России, купить автозапчасти с доставкой, автозапчасти онлайн, заказать автозапчасти, автозапчасти почтой, автозапчасти транспортной компанией'
...
# Логирование для диагностики обмена с 1С
LOGGING = {
    'version': 1,
